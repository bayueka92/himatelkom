...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 20 Des 2020 pada 21.03
...
CREATE TABLE `pendaftaran` (
  ...
  `alamat_kerja` varchar(300) NOT NULL,
  `jabatan` varchar(50) NOT NULL,
  `TA` varchar(100) NOT NULL DEFAULT '-',
  `kesan` varchar(50) NOT NULL,
  `konfirmasi` enum('pending','accepted','declined','') NOT NULL DEFAULT 'pending',
...
--
ALTER TABLE `berita`
  MODIFY `id_berita` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=201;
...
--
ALTER TABLE `pendaftaran`
  MODIFY `id_pendaftaran` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=437;
COMMIT;
